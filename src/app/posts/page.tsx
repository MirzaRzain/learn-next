  ...
  const handleDelete = async (id) => {
    if (confirm("Are you sure you want to delete this post?")) {
      try {
        ...
        toast.success("Deleted data succesfully!")
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <button 
          ...
          className="inline-block mx-3 mb-8 px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition duration-300"
        >Logout</button>
